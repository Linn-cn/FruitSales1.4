...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm addAccessory">
    ...
    layui.use(['table','layer','form'],function(){
        ...
        $(".addAccessory").click(function(){
            layer.open({
                ...
                + "<input type='text' name='accessoryName' class='layui-input' placeholder='请输入名字'>"
                + "</div></div>"
                + "<div class='layui-form-item layui-row layui-col-xs12'>"
                + "<label class='layui-form-label'>单价</label>"
                + "<div class='layui-input-inline'>"
                + "<input type='text' name='accessoryPrice' class='layui-input' placeholder='请输入价格'>"
                + "</div></div>"
                + "<div class='layui-form-item layui-row layui-col-xs12'>"
