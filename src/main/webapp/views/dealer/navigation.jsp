    ...
    <ul class="layui-nav right right1" lay-filter="">
        <li class="layui-nav-item"><a href="javascript:;"><shiro:principal/></a>
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
                    <a onclick="x_admin_show('个人信息','views/peasant/peasantUserInfo.jsp',500,600)"><i class="fa fa-address-card-o"
    ...
    <div id="side-nav">
        <ul id="nav">
            <li><a href="javascript:;"><i class="layui-icon">&#xe770;</i>
                ...
                <ul class="sub-menu">
                    <li><a _href="dealer/gotoPeasantList"> <i
                            class="iconfont">&#xe6a7;</i> <cite>果农列表</cite>
                    </a></li>
                </ul></li>
            <li><a href="javascript:;"> <i class="layui-icon">&#xe6b2;</i>
                ...
                <ul class="sub-menu">
                    <li><a _href="dealer/gotoContractList"> <i
